...
<div style="height: 500px; margin-bottom: 250px;" align="center">
	<form action="notice/nupdateaction.jsp" method="post">
			...
			<tr>
				<td colspan="2" align="center">
					...
					<button type="button" class="btn btn-danger" style="width: 120px;"
						onclick="location.href='index.jsp?main=notice/detail.jsp?num=<%= dto.getNum() %>&currentPage=<%= currentPage %>'">취소</button>
				</td>
			</tr>
		</table>
	</form>
