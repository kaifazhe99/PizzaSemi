	...
	%>
			<tr>
				<th><span style="font-size: 1.7em;"><%= dto.getSubject() %></span>
					<br> <span><img src="notice/admin.png"
			...
			<tr>
				<td>
					...
					<button type="button" class="btn btn-sm btn-success"
						...
						onclick="location.href='index.jsp?main=notice/noticelist.jsp?currentPage=<%=currentPage%>'">목록</button>
				...
				%>
					<button type="button" class="btn btn-sm btn-success"
						style="width: 80px; color: white;"
						onclick="location.href='index.jsp?main=notice/nupdateform.jsp?num=<%=dto.getNum()%>&currentPage=<%=currentPage%>'">수정</button>
				...
				<td>
					...
					<div class="comment">
						...
						<div class="commentform">
							<form action="notice/ncommentinsert.jsp" method="post">
