...
<body>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="py-5 row d-flex align-items-center">
                            <div class="banner-content">
                            	<img src="mainmenu/img/slideimg1.jpg">
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        <div class="py-5 row d-flex align-items-center">
                            <div class="banner-content">
                                <img src="mainmenu/img/slideimg2.jpg">
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        <div class="py-5 row d-flex align-items-center">
                            <div class="banner-content">
                                <img src="mainmenu/img/slideimg3.jpg">
                            </div>
                        </div>
        ...
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="navbar-toggler-success">
                ...
                <div class="navbar align-self-center d-flex">
                    ...
                    <a class="nav-link text-dark" href="#"><i class='bx bx-user-circle bx-sm text-danger'></i>로그인</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <!-- Bootstrap -->
    <script src="mainmenu/js/bootstrap.bundle.min.js"></script>
    <!-- Load jQuery require for isotope -->
    <script src="mainmenu/js/jquery.min.js"></script>
    <!-- Isotope -->
    <script src="mainmenu/js/isotope.pkgd.js"></script>
    <!-- Page Script -->
    <script>
    ...
    <!-- Templatemo -->
    <script src="mainmenu/js/templatemo.js"></script>
    <!-- Custom -->
    <script src="mainmenu/js/custom.js"></script>
