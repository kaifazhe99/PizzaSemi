...
<body>
	...
	<section class="container py-5">
		<div class="row pb-4">
			...
			<!-- Start Contact Form -->
			<div class="col-lg-8 ">
				<form action="pizzamenu/updateaction.jsp" method="post" enctype="multipart/form-data"
					class="form-inline">
				<input type="hidden" name="num" value="<%=num%>">
					<div class="col-lg-6 mb-4">
						<div class="form-floating">
							<textarea class="form-control"
								id="floatingname" name="pname" required="required"><%=dto.getPname()%></textarea>
					...
					<div class="col-lg-6 mb-4">
						<div class="form-floating">
							<textarea class="form-control"
								id="floatingphone" name="price" required="required"><%=dto.getPrice() %></textarea>
				...
				onclick="location.href='index.jsp?main=pizzamenu/menulist.jsp'">취소(목록으로)</button>
							<br>
						<br>
					</div>
				</form>
